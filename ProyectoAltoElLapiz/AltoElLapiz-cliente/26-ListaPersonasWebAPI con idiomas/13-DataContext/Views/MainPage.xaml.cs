...
namespace _13_DataContext
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void lsbPersonas_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            ListView listView = (ListView)sender;
            //this.lsbPersonas.SelectedItem = e.OriginalSource;
          
            allContactsMenuFlyout.ShowAt(listView, e.GetPosition(listView));
            clsPersona personaSeleccionada = (clsPersona)((FrameworkElement)e.OriginalSource).DataContext;
            this.lsbPersonas.SelectedItem = personaSeleccionada;
        }
